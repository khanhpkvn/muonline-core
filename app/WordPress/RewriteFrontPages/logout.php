...
namespace MUONLINECORE\App\WordPress\RewriteFrontPages;
...
class logout extends BaseRewriteFrontPage {

	use InstancesTrait;

//	public $path                     = null;
	public $rewriteIdent             = 'logout';
...
//		$this->seo = new RankmathSEO();
		...
		$this->seo->setDescription('Rewrite front page "logout" custom SEO description.');
		...
		$this->seo->setOpengraphDescription('Rewrite front page "logout" custom SEO description.');
