...
use MUONLINECORE\App\Http\Requests\SettingsUpdateRequest;
...
//		throw new \MUONLINECORE\App\Exceptions\QueryException($wpdb->last_query, $data, 'Testing QueryException...');

		// Test ModelNotFoundException.
//		$model = \MUONLINECORE\App\Models\SettingsModel::query()->findOrFail(9999999)->first();
...
//		throw new AuthenticationException('Testing AuthenticationException...');
		...
		// Test HttpException.
//		throw new \MUONLINECORE\App\Exceptions\HttpException(500, 'Testing HttpException...');
	}
