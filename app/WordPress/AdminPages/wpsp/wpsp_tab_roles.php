...
use MUONLINECORE\App\Widen\Support\Facades\View;
use MUONLINECORE\App\Widen\Support\Facades\WPRoles;
	...
	public function matchedCurrentAccess() {
		...
		if ($isListPage) {
			add_action('current_screen', function($screen) {
				$this->table = new \MUONLINECORE\App\WordPress\ListTables\Roles();
