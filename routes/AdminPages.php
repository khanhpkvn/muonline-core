...
use MUONLINECORE\App\Http\Middleware\VerifiedUserMiddleware;
use MUONLINECORE\App\Widen\Routes\AdminPages\AdminPages as Route;
use MUONLINECORE\App\Http\Middleware\AdministratorCapability;
use MUONLINECORE\App\Http\Middleware\AuthenticationMiddleware;
use MUONLINECORE\App\Http\Middleware\EditorCapability;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_child_example;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_child_post_type_wpsp_content;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_child_taxonomy_wpsp_category;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_dashboard;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_database;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_license;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_permissions;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_roles;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_settings;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_table;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_tools;
use MUONLINECORE\App\WordPress\AdminPages\wpsp\wpsp_tab_users;
...
//		])->get('wpsp2', function(
//			$page_title = 'MUONLINECORE2',
//			$menu_title = 'MUONLINECORE2',
...
//					$parent_slug = 'wpsp2',
//					$page_title = 'MUONLINECORE3 Last child',
//					$menu_title = 'MUONLINECORE3 Last child',
//					$capability = 'administrator',
...
//			$is_submenu_page = true,
//			$parent_slug = 'wpsp2',
//			$page_title = 'MUONLINECORE2 Child',
//			$menu_title = 'MUONLINECORE2 Child',
//			$capability = 'administrator',
