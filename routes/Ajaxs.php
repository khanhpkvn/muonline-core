...
use MUONLINECORE\App\Widen\Routes\Ajaxs\Ajaxs as Route;
use MUONLINECORE\App\Http\Controllers\AjaxsController;
use MUONLINECORE\App\Http\Middleware\AdministratorCapability;
use MUONLINECORE\App\Http\Middleware\ApiTokenAuthentication;
...
class Ajaxs {
	...
	public function ajaxs() {
		...
		Route::post('muoc_handle_database', [AjaxsController::class, 'handleDatabase'])->name('handle_database');
	}
