...
@section('title')
    {{ muoc_trans('Users', true) }}
@endsection

@section('after-title')
    <a href="?page={{$menuSlug}}&tab=users&action=create" class="page-title-action">{{ muoc_trans('Add new', true) }}</a>
@endsection
                    ...
                    <div class="meta-box-sortables ui-sortable">
                        <div class="postbox">
                            ...
                            <div class="postbox-header">
                                <h2 class="hndle ui-sortable-handle">{{ muoc_trans('messages.information') }}</h2>
                ...
                <div class="col">
                    <div class="meta-box-sortables ui-sortable">
                        <div class="postbox">
                            ...
                            <div class="postbox-header">
                                <h2 class="hndle ui-sortable-handle">{{ muoc_trans('messages.roles') }}</h2>
                                <div class="handle-actions">
                                    <button type="button" class="handlediv" aria-expanded="true">
                                        <span class="toggle-indicator"></span>
                                    </button>
                    ...
                    <div class="meta-box-sortables ui-sortable">
                        <div class="postbox">
                            ...
                            <div class="postbox-header">
                                <h2 class="hndle ui-sortable-handle">{{ muoc_trans('messages.permissions') }}</h2>
                                <div class="handle-actions">
                                    <button type="button" class="handlediv" aria-expanded="true">
                                        <span class="toggle-indicator"></span>
                                    </button>
                ...
                <div class="col">
                    <div class="meta-box-sortables ui-sortable">
                        <div class="postbox">
                            ...
                            <div class="postbox-header">
                                <h2 class="hndle ui-sortable-handle">{{ muoc_trans('Add new user', true) }}</h2>
                                <div class="handle-actions">
                                    <button type="button" class="handlediv" aria-expanded="true">
                                        <span class="toggle-indicator"></span>
                                    </button>
                ...
                <div class="col">
                    <div class="meta-box-sortables ui-sortable">
                        <div class="postbox">
                            ...
                            <div class="postbox-header">
                                <h2 class="hndle ui-sortable-handle">{{ muoc_trans('Edit user', true) }}</h2>
                                <div class="handle-actions">
                                    <button type="button" class="handlediv" aria-expanded="true">
                                        <span class="toggle-indicator"></span>
                                    </button>
                        ...
                        <button type="submit" class="button button-primary">{{ muoc_trans('Update', true) }}</button>
                    </div>
                </div>
            </div>
        </form>
