                ...
                @if($checkDatabase['type'] == 'check_all_database_table_exists')
                    <div class="notice notice-warning inline">
                        <p>
                            ...
                            You need to drop all database tables what are used for <b>{{ muoc_config('app.name')  }}</b>.<br/>
                            Don't worry, <b>{{ muoc_config('app.name')  }}</b> only uses its own database tables, and they need to dropped, then new database tables will be created again.<br/>
...
{{--			"nonce": "{{ wp_create_nonce(muoc_config('app.short_name')) }}",--}}
