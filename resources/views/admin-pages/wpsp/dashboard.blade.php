                            ...
                            <tr>
                                <td>
                                    @if (isset($current_user) && $current_user)
                                        ...
                                        <form method="POST" action="{{ muoc_route('Apis', 'auth.logout', true) }}">
                                    ...
                                    @else
                                        <div class="row">
                                            <div class="col">
                                                <form method="POST" action="{{ muoc_route('Apis', 'auth.login', true) }}">
                                                ...
                                                <br/>
                                                Not have account? <a href="{{ muoc_route('RewriteFrontPages', 'auth.register', true) }}">Register</a>
                                            </div>
                                            <div class="col">
                                                <form method="POST" action="{{ muoc_route('Apis', 'auth.forgot_password', true) }}">
