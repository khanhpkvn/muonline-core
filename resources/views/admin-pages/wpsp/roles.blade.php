...
@section('title')
    {{ muoc_trans('Roles', true) }}
@endsection

@section('after-title')
    <a href="?page={{$menuSlug}}&tab=roles&action=create" class="page-title-action">{{ muoc_trans('Add new', true) }}</a>
    <a href="?page={{$menuSlug}}&tab=roles&action=refresh" class="button-primary page-title-action">{{ muoc_trans('Refresh all custom roles', true) }}</a>
@endsection
                    ...
                    <div class="meta-box-sortables ui-sortable">
                        <div class="postbox">
                            ...
                            <div class="postbox-header">
                                <h2 class="hndle ui-sortable-handle">{{ muoc_trans('Add new role', true) }}</h2>
